...
"let $LANG='en'
set nocompatible
set fileencodings=utf8,cp1251,koi8-r,cp866,ucs-2le   " список предполагаемых кодировок, в порядке предпочтения
...
set novisualbell " вместо писка бипером мигать курсором при ошибках ввода
...
function GlobalSettings() " {{{
	map <F3> :cn <cr>
	map <F2> :cp <cr>	
	"map <M-F1> :call QuickFix_Toggle() <cr>
